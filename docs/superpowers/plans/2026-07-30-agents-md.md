...
**Interfaces:**
- Consumes: RTK policy from `~/.codex/RTK.md`, workspace metadata from `Cargo.toml`, and repository decisions from the two documents under `docs/plans/`.
...
```bash
rtk rg -n '^@~/.codex/RTK.md$' AGENTS.md
